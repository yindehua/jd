<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\phpStudy\WWW\jd\public/../application/admin\view\cate\del.html";i:1519883651;s:60:"D:\phpStudy\WWW\jd\application\admin\view\public\navbar.html";i:1519824989;s:61:"D:\phpStudy\WWW\jd\application\admin\view\public\sidebar.html";i:1519893913;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
							...
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="<?php echo url('cate/addhanddle'); ?>" method="post">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input id="cate_name" name="cate_name" placeholder="请输入分类名称" class="col-xs-10 col-sm-5" type="text">
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										...
										<input type="submit" name="" value="添加分类" class="btn btn-success">
										<input type="reset" name="" value="取消添加" class="btn btn-danger">
										</div>
									</div>
