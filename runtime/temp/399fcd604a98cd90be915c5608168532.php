<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\phpStudy\WWW\jd\public/../application/admin\view\cate\catelist.html";i:1520249126;s:60:"D:\phpStudy\WWW\jd\application\admin\view\public\navbar.html";i:1519824989;s:61:"D:\phpStudy\WWW\jd\application\admin\view\public\sidebar.html";i:1520636495;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
					...
					<form action="<?php echo url('cate/sort'); ?>" method="post">
						<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
										<thead>
											...
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 116px;" aria-label="Price: activate to sort column ascending">分类名称</th>
											<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 116px;" aria-label="Price: activate to sort column ascending">排序</th>
											<th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 126px;" aria-label="Clicks: activate to sort column ascending">操作</th>
											</tr>
										</thead>
											...
											<tr class="odd">
												...
												<td class=" ">
													<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
														...
														<?php echo url('cate/del',array('cate_id'=>$vo['cate_id'])); ?>'">
