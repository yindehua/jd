<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\phpStudy\WWW\jd\public/../application/admin\view\cate\upd.html";i:1520171479;s:60:"D:\phpStudy\WWW\jd\application\admin\view\public\navbar.html";i:1519824989;s:61:"D:\phpStudy\WWW\jd\application\admin\view\public\sidebar.html";i:1520163314;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
							...
							<div class="col-xs-12">
								...
								<input type="hidden" name="cate_id" value="<?php echo $cate_find['cate_id']; ?>">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input id="cate_name" name="cate_name" placeholder="请输入分类名称" class="col-xs-10 col-sm-5" type="text"  value="<?php echo $cate_find['cate_name']; ?>">
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 所属分类 </label>
												<!-- 原本列出所有的分类，但是condition用$vo.cate_id eq $cate_find.cate_pid导致其所属分类被选selected -->
										<div class="col-sm-2">
											<select class="form-control" id="pid" name="cate_pid">
												...
												selected=""
												<?php endif; ?>><?php echo $vo['str']; ?><?php echo $vo['cate_name']; ?></option>
									...
									<div class="clearfix form-actions">
										...
										<input type="submit" name="" value="修改分类" class="btn btn-success">
										<input type="reset" name="" value="取消修改" class="btn btn-danger">
										</div>
									</div>
