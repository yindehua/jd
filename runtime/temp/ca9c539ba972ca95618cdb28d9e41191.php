<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpStudy\WWW\jd\public/../application/admin\view\keywords\upd.html";i:1520171574;s:60:"D:\phpStudy\WWW\jd\application\admin\view\public\navbar.html";i:1519824989;s:61:"D:\phpStudy\WWW\jd\application\admin\view\public\sidebar.html";i:1520163314;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="<?php echo url('keywords/updhanddle'); ?>" method="post">
								<input type="hidden" name="keywords_id" value="<?php echo $keywords_find['keywords_id']; ?>">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input id="keywords_name" name="keywords_name" placeholder="请输入修改内容" class="col-xs-10 col-sm-5" type="text" value="<?php echo $keywords_find['keywords_name']; ?>">
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										...
										<input type="submit" name="" value="修改" class="btn btn-success">
										<input type="reset" name="" value="取消" class="btn btn-danger">
										</div>
									</div>
