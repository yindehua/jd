<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\phpStudy\WWW\jd\public/../application/admin\view\goods\upd.html";i:1520425761;s:60:"D:\phpStudy\WWW\jd\application\admin\view\public\navbar.html";i:1519824989;s:61:"D:\phpStudy\WWW\jd\application\admin\view\public\sidebar.html";i:1520163314;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
				...
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo url('goods/updhanddle'); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-xs-10">
								<input id="goods_sales" name="goods_sales" placeholder="请输入商品销量" 
								class="col-xs-10 col-sm-5" type="text" value="<?php echo $goods_find['goods_sales']; ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-10">
								<input id="goods_inventory" name="goods_inventory" placeholder="请输入商品库存" 
								class="col-xs-10 col-sm-5" type="text" value="<?php echo $goods_find['goods_inventory']; ?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="preview" style="margin-top:20px;">
								...
								<div style='margin-top:10px;'><img src={'$vo.url'} width='100'>
								<a class='img_cancle btn btn-warning' role='button' style=''>删除</a></div>
								<?php endforeach; endif; else: echo "" ;endif; ?>	
							</div>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-1 control-label no-padding-right" for="goods_status"> 商品状态 </label>
							<div class="col-xs-10">
						...
						<div class="col-xs-10">
						<img src="<?php echo $goods_find['goods_thumb']; ?>" id="img" name="img" an id="thumb_upload" class="btn fileinput-button" style="width:18%">
						...
						style="width:18%;display:none">  
						<span>上传</span>
						<input id="goods_thumb" placeholder="" class="" type="file" name="goods_thumb">
						</span>
						<a id="thumb_cancle" href="javascript:void(0)" class="btn btn-warning" role="button" onclick="cancleUpload()" style="width:18%;display:block" >删除</a>  
						</div>
						</div>
