<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\phpStudy\WWW\jd\public/../application/index\view\goods\goodslist.html";i:1520260348;}*/ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="/public/static/index/css/seastyle.css" rel="stylesheet" type="text/css" />
...
#page1 li{
	...
	<body>
						...
						<div class="am-u-sm-12 am-u-md-12">
							...
							<div class="search-content">
								<div class="sort">
									...
									<li><a title="销量" href="<?php echo url('goods/goodslist',array('goods_pid'=>$goods_pid,'goods_order'=>'goods_sales')); ?>">销量优先</a></li>
									<li><a title="价格" href="<?php echo url('goods/goodslist',array('goods_pid'=>$goods_pid,'goods_order'=>'goods_price_asc')); ?>">价格最低</a></li>
									<li><a title="价格" href="<?php echo url('goods/goodslist',array('goods_pid'=>$goods_pid,'goods_order'=>'goods_price_desc')); ?>">价格最高</a></li>
							...
							<div class="clear"></div>
							<!--分页 -->
							<ul class="am-pagination am-pagination-right" id="page1">
							<?php echo $show; ?>
		...
		<div class="navCir">
			...
			<li><a href="/public/static/index/person/index.html"><i class="am-icon-user"></i>我的</a></li>					
		</div>
